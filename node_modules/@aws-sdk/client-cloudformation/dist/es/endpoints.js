...
var AWS_TEMPLATE = "cloudformation.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "cloudformation.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "cloudformation.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "cloudformation.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "cloudformation.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "cloudformation" }, regionInfo));
};
